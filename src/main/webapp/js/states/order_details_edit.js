 ...
 */
angular.module("digitalbusiness.states.order_details_edit", [])
        .config(function ($stateProvider, templateRoot) {
            $stateProvider.state('admin.carcass_edit', {
                'url': '/:carcassDetailId/carcass_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/carcass_edit.html',
                'controller': 'CarcassEditController'
            });
            $stateProvider.state('admin.panel_edit', {
                'url': '/:panelDetailId/panel_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/panel_edit.html',
                'controller': 'PanelEditController'
            });
            $stateProvider.state('admin.shutter_edit', {
                'url': '/:shutterDetailId/shutter_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/shutter_edit.html',
                'controller': 'ShutterEditController'
            });
            $stateProvider.state('admin.drawer_edit', {
                'url': '/:drawerDetailId/drawer_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/drawer_edit.html',
                'controller': 'DrawerEditController'
            });
            $stateProvider.state('admin.filler_edit', {
                'url': '/:fillerDetailId/filler_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/filler_edit.html',
                'controller': 'FillerEditController'
            });
            $stateProvider.state('admin.pelmet_edit', {
                'url': '/:pelmetDetailId/pelmet_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/pelmet_edit.html',
                'controller': 'PelmetEditController'
            });
            $stateProvider.state('admin.cornice_edit', {
                'url': '/:corniceDetailId/cornice_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/cornice_edit.html',
                'controller': 'CorniceEditController'
            });
            $stateProvider.state('admin.handle_edit', {
                'url': '/:handleDetailId/handle_edit',
                'templateUrl': templateRoot + '/masters/order_details_edit/handle_edit.html',
                'controller': 'HandleEditController'
            });
//            $stateProvider.state('admin.hardware_repeat_add', {
//                'url': '/:hardwareDetailId/hardware_addition',
...
//                'url': '/:dealerSkuId/panel_addition',
...
//                        });
            ...
            $scope.saveOrderDetail = function (orderDetail) {
                ...
                var w1;
                var d1;
                orderDetail.orderHeadId = $scope.orderHeadId;
//                ////////Process Length////////////
...
//                        var productCode = orderDetail.component + "" + orderDetail.carcassSubType + "18" + orderDetail.material + "A" + orderDetail.sideFinish + "-" + l1 + "" + w1 + "18" + d1;
        ...
        .controller('PanelEditController', function (PanelMaterialThicknessService, RateContractDetailService, FinishPriceService, ColorConstraintService, PartyService, OrderHeadService, ColorService, RawMaterialService, KitchenComponentService, PanelOrderDetailsService, $scope, $stateParams, $state) {
...
//            });
            if ($stateParams.panelDetailId === undefined) {
                ...
                PanelOrderDetailsService.get({
                    ...
                    OrderHeadService.get({
                        'id': panelOrderDetailObject.orderHeadId
                    }, function (orderHeadObject) {
                        PartyService.get({
                            'id': orderHeadObject.billingPartyId
                        }, function (partyObject) {
                            console.log("Party Object :%O", partyObject);
                            panelOrderDetailObject.rateContractId = partyObject.rateContractId;
                        });
                    });
...
//                        $scope.orderHead.orderSubType = 'X';
//                        if ($scope.orderHead.orderSubType === "D") {
//                            console.log("Display Order");
...
//                            panelOrderDetail.$save(function () {
//                                console.log("Updated Successfully");
//                                $scope.editablePanelDetail = "";
//                                $scope.panelName = "";
//                                $state.go('admin.masters_order_details', {
...
//                        } else {
                        ...
                        console.log("Panle Order Detail Save Object :%O", panelOrderDetail);
                        panelOrderDetail.$save(function (panelOrderDetail) {
                            console.log("Updated Successfully");
                            $scope.editablePanelDetail = "";
                            $scope.panelName = "";
                            $state.go('admin.masters_order_details', {
                                'orderHeadId': panelOrderDetail.orderHeadId
                            }, {'reload': true});
                        });
//                        }
                    });
...
//                panelOrderDetail.orderHeadId = panelOrderDetail.orderHeadId;
...
//                    $scope.editableShutterDetail.handleFinish = shutterOrderDetailObject.handleFinish;
                    ...
                    OrderHeadService.get({
                        'id': shutterOrderDetailObject.orderHeadId
                    }, function (orderHeadObject) {
                        console.log("Order Head Object :%O", orderHeadObject);
                        PartyService.get({
                            'id': orderHeadObject.billingPartyId
                        }, function (partyObject) {
                            shutterOrderDetailObject.rateContractId = partyObject.rateContractId;
//                            shutterOrderDetailObject.orderHeadId = orderHeadObject.id;
                        });
                    });
...
//            });
            ...
            $scope.saveShutterDetails = function (shutterOrderDetail) {
                $scope.applyShutterDiscount = function (shutterOrderDetail, handlePrice, jaliPrice, straightenerPrice) {
                    ...
                    console.log("Shutter Order Detail Object :%O", shutterOrderDetail);
...
//                            shutterOrderDetail.$save(function () {
//                                $scope.editableShutterDetail = "";
//                                $scope.shutterName = "";
...
//                        } else {
                        ...
                        shutterOrderDetail.$save(function (shutterOrderDetail) {
                            console.log("After Sav Object :%O", shutterOrderDetail);
                            $scope.editableShutterDetail = "";
                            $scope.shutterName = "";
                            $scope.shutterColorName = "";
                            $scope.shutterHandleName = "";
                            $state.go('admin.masters_order_details', {
                                'orderHeadId': shutterOrderDetail.orderHeadId
                            }, {'reload': true});
                        });
//                        }
                    });
...
//                shutterOrderDetail.orderHeadId = $stateParams.orderHeadId;
        ...
        .controller('DrawerEditController', function (RateContractDetailService, FinishPriceService, ColorConstraintService, PartyService, OrderHeadService, ColorService, RawMaterialService, KitchenComponentService, PanelOrderDetailsService, $scope, $stateParams, $state) {

        })
        .controller('FillerEditController', function (FillerFinishPriceService, RateContractDetailService, FinishPriceService, ColorConstraintService, PartyService, OrderHeadService, ColorService, RawMaterialService, KitchenComponentService, FillerOrderDetailsService, $scope, $stateParams, $state) {
//            OrderHeadService.get({
//                'id': $stateParams.orderHeadId
//            }, function (orderHeadObject) {
//                $scope.orderHead = orderHeadObject;
//            });
            if ($stateParams.fillerDetailId === undefined) {
                ...
                FillerOrderDetailsService.get({
                    ...
                    OrderHeadService.get({
                        'id': fillerOrderDetailObject.orderHeadId
                    }, function (orderHeadObject) {
                        PartyService.get({
                            'id': orderHeadObject.billingPartyId
                        }, function (partyObject) {
                            fillerOrderDetailObject.rateContractId = partyObject.rateContractId;
                        });
                    });
...
//                            fillerOrderDetail.$save(function (fillerOrderDetail) {
//                                $scope.editablePanelDetail = "";
//                                $scope.fillerColorName = "";
//                                $state.go('admin.masters_order_details', {
//                                    'orderHeadId': fillerOrderDetail.orderHeadId
//                                }, {'reload': true});
//                            });
//                        } else {
...
//                var productCode = fillerOrderDetail.component + "-18" + fillerOrderDetail.material + "-" + l1 + "" + w1 + "18000";
        ...
        .controller('PelmetEditController', function (PanelMaterialThicknessService, FillerFinishPriceService, PelmetOrderDetailsService, RateContractDetailService, FinishPriceService, ColorConstraintService, PartyService, OrderHeadService, ColorService, RawMaterialService, KitchenComponentService, PanelOrderDetailsService, $scope, $stateParams, $state) {
            OrderHeadService.get({
                'id': $stateParams.orderHeadId
            }, function (orderHeadObject) {
                $scope.orderHead = orderHeadObject;
                ...
                $scope.applyPelmetDiscount = function (pelmetOrderDetail) {
                    RateContractDetailService.findByShutterFinishMaterialThickness({
                        ...
                        if ($scope.orderHead.orderSubType === "D") {
                            ...
                            pelmetOrderDetail.$save(function () {
                                $scope.editablePelmetDetail = "";
                                $scope.pelmetColorName = "";
                                $state.go('admin.masters_order_details', {
                                    'orderHeadId': $stateParams.orderHeadId
...
//            });
            if ($stateParams.corniceDetailId === undefined) {
                ...
                CorniceOrderDetailsService.get({
                    ...
                    OrderHeadService.get({
                        'id': corniceOrderDetailObject.orderHeadId
                    }, function (orderHeadObject) {
                        PartyService.get({
                            'id': orderHeadObject.billingPartyId
                        }, function (partyObject) {
                            corniceOrderDetailObject.rateContractId = partyObject.rateContractId;
                        });
                    });
                    KitchenComponentService.findByComponentCode({
...
//                            corniceOrderDetail.$save(function () {
//                                $scope.editableCorniceDetail = "";
//                                $scope.corniceColorName = "";
//                                $state.go('admin.masters_order_details', {
//                                    'orderHeadId': $stateParams.orderHeadId
...
//                var productCode = corniceOrderDetail.component + "-18" + corniceOrderDetail.material + "-" + l1 + "" + w1 + "18000";
        ...
        .controller('HandleEditController', function (HandlePriceService, HandleOrderDetailsService, RateContractDetailService, FinishPriceService, ColorConstraintService, PartyService, OrderHeadService, ColorService, RawMaterialService, KitchenComponentService, PanelOrderDetailsService, $scope, $stateParams, $state) {
            OrderHeadService.get({
                'id': $stateParams.orderHeadId
            }, function (orderHeadObject) {
                $scope.orderHead = orderHeadObject;
...
//                handleOrderDetail.material = '';
                ...
                if ($scope.orderHead.orderSubType === "D") {
                    ...
                    handleOrderDetail.$save(function () {
                        $scope.editableHandleDetail = "";
                        $scope.handleName = "";
                        $state.go('admin.masters_order_details', {
                            'orderHeadId': $stateParams.orderHeadId
