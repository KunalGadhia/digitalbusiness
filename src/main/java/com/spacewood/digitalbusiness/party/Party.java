...
public class Party {
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + Objects.hashCode(this.dealerCode);
        hash = 37 * hash + Objects.hashCode(this.dealerName);
        hash = 37 * hash + Objects.hashCode(this.glCode);
        hash = 37 * hash + Objects.hashCode(this.contactPerson);
        hash = 37 * hash + Objects.hashCode(this.billingAdd1);
        hash = 37 * hash + Objects.hashCode(this.billingAdd2);
        hash = 37 * hash + Objects.hashCode(this.billingAdd3);
        hash = 37 * hash + Objects.hashCode(this.billingAdd4);
        hash = 37 * hash + Objects.hashCode(this.billingEmail);
        hash = 37 * hash + Objects.hashCode(this.city);
        hash = 37 * hash + Objects.hashCode(this.billingFax);
        hash = 37 * hash + Objects.hashCode(this.billBoardTel);
        hash = 37 * hash + Objects.hashCode(this.directTelNo);
        hash = 37 * hash + Objects.hashCode(this.panNumber);
        hash = 37 * hash + Objects.hashCode(this.gstNumber);
        hash = 37 * hash + Objects.hashCode(this.state);
        hash = 37 * hash + Objects.hashCode(this.marketingHeadId);
        return hash;
    }
