 ...
 * @author User
 */
public class InfinityWardrobeMrpOrderDetails {
    private Integer id;
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.carcass);
        hash = 59 * hash + Objects.hashCode(this.carcassPrice);
        hash = 59 * hash + Objects.hashCode(this.shutter);
        hash = 59 * hash + Objects.hashCode(this.shutterPrice);
        hash = 59 * hash + Objects.hashCode(this.hinges);
        hash = 59 * hash + Objects.hashCode(this.hingesPrice);
        ...
        hash = 59 * hash + Objects.hashCode(this.carcassColor);
        hash = 59 * hash + Objects.hashCode(this.shutterColor);
    ...
    public boolean equals(Object obj) {
        ...
        final InfinityWardrobeMrpOrderDetails other = (InfinityWardrobeMrpOrderDetails) obj;
