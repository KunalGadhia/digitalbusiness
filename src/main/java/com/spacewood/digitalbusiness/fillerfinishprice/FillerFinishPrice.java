 ...
 * @author webdesign
 */
public class FillerFinishPrice {
    private Integer id;
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + Objects.hashCode(this.oneSidePrice);
        hash = 79 * hash + Objects.hashCode(this.bothSidePrice);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final FillerFinishPrice other = (FillerFinishPrice) obj;
    ...
    public String toString() {
        return "FillerFinishPrice{" + "id=" + id + ", finish=" + finish + ", material=" + material + ", thickness=" + thickness + ", oneSidePrice=" + oneSidePrice + ", bothSidePrice=" + bothSidePrice + '}';
    }
