 ...
 * @author User
 */
public class MaxWardrobesMrpOrderDetails {
    private Integer id;
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + Objects.hashCode(this.carcass);
        hash = 89 * hash + Objects.hashCode(this.carcassPrice);
        hash = 89 * hash + Objects.hashCode(this.shutter);
        hash = 89 * hash + Objects.hashCode(this.shutterPrice);
        hash = 89 * hash + Objects.hashCode(this.hinges);
        hash = 89 * hash + Objects.hashCode(this.hingesPrice);
        hash = 89 * hash + Objects.hashCode(this.handle);
        hash = 89 * hash + Objects.hashCode(this.handlePrice);
        ...
        hash = 89 * hash + Objects.hashCode(this.carcassColor);
        hash = 89 * hash + Objects.hashCode(this.shutterColor);
    ...
    public boolean equals(Object obj) {
        ...
        final MaxWardrobesMrpOrderDetails other = (MaxWardrobesMrpOrderDetails) obj;
    ...
    public String toString() {
        return "MaxWardrobesMrpOrderDetails{" + "id=" + id + ", orderHeadId=" + orderHeadId + ", productCode=" + productCode + ", description=" + description + ", carcass=" + carcass + ", carcassPrice=" + carcassPrice + ", shutter=" + shutter + ", shutterPrice=" + shutterPrice + ", hinges=" + hinges + ", hingesPrice=" + hingesPrice + ", handle=" + handle + ", handlePrice=" + handlePrice + ", width=" + width + ", depth=" + depth + ", height=" + height + ", carcassColor=" + carcassColor + ", shutterColor=" + shutterColor + ", quantity=" + quantity + ", price=" + price + ", remark=" + remark + '}';
    }    
