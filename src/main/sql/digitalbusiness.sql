...
CREATE TABLE `color_code_master` (
  ...
  `category` varchar(100) DEFAULT NULL COMMENT 'JAVA ENUM com.spacewood.digitalbusiness.color.ColorCategory',
...
-- Dump completed on 2017-11-10 14:24:40
